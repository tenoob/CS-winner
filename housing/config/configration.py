...
class Configration:
    ...
    def get_data_transformation_config(self) -> DataTranformationConfig:
        try:
            ...
            preprocessed_object_file_path = os.path.join(
                ...
                data_transformation_config_info[DATA_TRANSFORMATION_PREPROCESSED_OBJECT_FILE_NAME])
    ...
    def get_model_trainer_config(self) -> ModelTrainerConfig:
        try:
            ...
            base_accuacy = model_trainer_config_info[MODEL_TRAINER_BASE_ACCURACY_KEY]

            model_trainer_config = ModelTrainerConfig(
                trained_model_file_path=trained_model_file_path,
                model_config_file_path=model_config_file_path,
                base_accuracy=base_accuacy
            )

            logging.info(f"ModelTrainer Config: {model_trainer_config}")
